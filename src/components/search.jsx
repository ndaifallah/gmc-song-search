...
class Search extends Component {
    ...
    render(){
        return(<div style={{
            ...
            <Button type="primary" shape="round" icon={<SearchOutlined />} size={"large"} style={{width:"150px",marginTop:'5px'}} onClick={e=> this.onClickSearch(e)} loading={this.state.loading}>
          Search 
        </Button>
        </div>
        )
